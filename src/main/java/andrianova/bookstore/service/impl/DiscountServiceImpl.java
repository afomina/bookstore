...
import andrianova.bookstore.domain.discount.ComparingCondition;
...
import static andrianova.bookstore.domain.discount.Clause.MORE;
...
public class DiscountServiceImpl implements DiscountService {
	...
	public List<Discount<Price>> getPriceDiscounts() {
		return Collections.singletonList(new Discount<>(
				Collections.singletonList(
						new ComparingCondition<>(MORE, Price.of(BigDecimal.valueOf(30.0)))
				),
